...
<style>
  ...
  .list_webtoon .link_webtoon .thumb_webtoon {float:left;width:50px;margin-right:10px}
  .list_webtoon .link_webtoon .info_webtoon {overflow:hidden}
  .list_webtoon .link_webtoon .img_webtoon {display:block;width:50px}
</style>
